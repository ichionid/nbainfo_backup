...
function responsive_bartik_preprocess_page(&$variables) {
  ...
  /*if($variables['elements']['#view_mode'] == 'frontepage_forum_topics') {
    //$variables['theme_hook_suggestion'] = 'advanced_forum_post_frontpage';
    $variables['theme_hook_suggestions'][] = 'advanced_forum_post_frontpage';
  }*/
}

function responsive_bartik_preprocess_comment(&$variables) {
  if($variables['elements']['#view_mode'] == 'frontepage_forum_topics') {
    //$variables['theme_hook_suggestion'] = 'advanced_forum_post_frontpage';
    $variables['theme_hook_suggestions'][] = 'advanced_forum_post_frontpage';
  }
